...
def scale_raw_input(raw_dict):
    """
    Convenience wrapper: runs all 4 preprocessing pipeline steps in order.
    ...
    if is_standardized:
        # If standardized, manually set the reference values for the scaler to align patient scale
        ...
        # Otherwise, compute from the raw training dataset dynamically
